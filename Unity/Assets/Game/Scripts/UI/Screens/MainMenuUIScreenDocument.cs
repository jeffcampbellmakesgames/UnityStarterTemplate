...
namespace Game
{
	...
	/// </summary>
	public sealed class MainMenuUIScreenDocument : UIScreenDocumentBase
	{
		...
		{
			var settingsUIScreen = UIScreenControl.GetScreen<SettingsMenuUIScreenDocument>();
		...
		{
			var creditsUIScreen = UIScreenControl.GetScreen<CreditsUIScreenDocument>();
